...
LANG_DATA = {
    ...
    "English": {
        ...
        "dmh_alert": "📢 Tip: Follow DMH news.",
        "storm_note": "📝 Note: Beware of thunderstorms.",
        "ibf_header": "🏥 Health Impacts",
        "risk_levels": ["Extreme", "High", "Moderate", "Low"],
        "charts": ["Temp", "Rain", "Wind", "Visibility", "Humidity", "Cloud", "Thunderstorm"],
        "impact_list": ["Danger!", "Warning", "Caution", "Normal"],
        "recom_list": ["Stay home", "Stay in shade", "Drink water", "Normal"]
    }
}
...
if df_h is not None:
    ...
    # --- 6. Export All Stations Section (Full Data) ---
    st.markdown("---")
    ...
    # --- 7. Data Legend Table (Bottom Part) ---
    st.markdown("""
